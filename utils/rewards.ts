...
export const rewards: Reward[] = [
  ...
  { id: 'fire_red', name: '🔥 Fire Red Theme', cost: 1200, type: 'theme' },
  ...
  { id: 'badge_cyberfox', name: '🦊 Cyber Fox Badge', cost: 1000, type: 'badge' },
  { id: 'badge_neoncat', name: '🐱‍👤 Neon Cat Badge', cost: 1500, type: 'badge' },
